...
| Planning (10) | write-plan, execute-plan, plan-manager, autonomous-execute, jira-plan, sk-jira, jira-rest, sk-execute, fpf-reasoning, discover-decide-design |
...
| Broker (3) | ask-coordinator, deploy, observability |
